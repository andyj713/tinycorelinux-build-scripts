...
# as of PHP 8.4 OCI is in PECL so two passes are no longer needed
# pear hangs when trying to build
...
# make Oracle pdo_oci
cd ext
tar xf $SOURCE/pdo_oci-1.1.0.tgz
mv pdo_oci-1.1.0 pdo_oci
cd pdo_oci
/usr/local/bin/phpize
